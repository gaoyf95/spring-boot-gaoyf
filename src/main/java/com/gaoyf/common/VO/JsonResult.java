...
public class JsonResult {
     ...
     * 成功的Json结果
     */
    private static final JsonResult code_instance = new JsonResult(HttpCode.OK.getValue(), "请求成功");
     ...
     * 失败的Json结果
     */
    private static final JsonResult code_fail = new JsonResult(HttpCode.FAILURE.getValue(), "请求失败");
